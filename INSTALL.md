...
4. Start the server:
   ...
   uv run python -m openmanus_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn openmanus_mcp.server:app --port 10768
   ```
5. Open `http://localhost:10768` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/openmanus-mcp/issues) |

...
Staggered, linked guides for **openmanus-mcp**. Start with **[INSTALL.md](INSTALL.md)** if you only want it running.

| Doc | Audience | What it covers |
|-----|----------|----------------|
| **[INSTALL.md](INSTALL.md)** | Everyone | Clone, `uv`, `.env`, MCP client `cwd`, webapp (`start.ps1`), ports |
...
| **[LMSTUDIO.md](LMSTUDIO.md)** | Local inference users | End-to-end LM Studio wiring for dashboard chat + OpenManus runtime |
...
**Project meta:** [CONTRIBUTING.md](../CONTRIBUTING.md) · [RELEASING.md](../RELEASING.md) · [.github/TOPICS.md](../.github/TOPICS.md)

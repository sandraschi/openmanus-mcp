...
const BACKEND_NAME: &str = "openmanus-mcp-backend.exe";
const BACKEND_PORT: u16 = 10768;
const BACKEND_TAG: &str = "openmanus-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "OPENMANUS_MCP_PORT";
const ENV_HOST: &str = "OPENMANUS_MCP_HOST";
const ENV_TAURI: &str = "OPENMANUS_MCP_TAURI";
